...
public class CmdLineParser
{
    ...
    /**
     * Parse a port number. If arg is not an positive integer, then defaultPort will
     * be used. if arg is less than 1024, then a warning will be generated since [0,
     * 1024) is the well-known port number range.
     * 
     * @param arg         the string to be parsed.
     * @param defaultPort the default port number that will be used if arg is
     *                    invalid
