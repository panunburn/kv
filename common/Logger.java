...
/**
 * 
 * These are the thread-safe logging interfaces.
 * It logs regular messages to STDOUT, warnings and errors to STDERR with the current time stamp (in milliseconds precision).
 *
 */
public class Logger
{
    ...
    public static PrintStream getLogStream() { return System.out; }
    
    public static PrintStream getWarningStream() { return System.err; }

    public static PrintStream getErrorStream() { return System.err; }
    ...
    /**
     * Log an exception by logging its message. 
     * If the message is null, then the actual exception will be logged.
     ...
     * If the exception message is null, then only the message will be logged.
     * @param msg the message to be logged
     * @param e the exception to be logged
     */
    ...
    /**
     * Log a debug exception by logging its message. 
     * If the message is null, then the actual exception will be logged.
     * @param e the exception to be logged
     */
	public static void debug(Exception e)
    {
	 ...
	 /**
     * Log a debug message along with a debug exception. 
     * If the exception message is null, then only the message will be logged.
     * @param msg the message to be logged
     * @param e the exception to be logged
     */
